...
it will output testCSL_autofmt.json with a new id tag.  The tag will follow this format:
    ...
    * firstauthorlastname_year_kw1_kw2_replicate where kw1 and kw2 are the first and second words in the title with three or more letters (excluding a subset of common words e.g. "the", "and", etc.), and replicate is a sequential alphabetic index
